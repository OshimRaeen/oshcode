    ...
    >
      <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
        {step === "select" ? (
          <>
            <DialogHeader>
              <DialogTitle className="text-2xl font-bold text-[#11BA3C] flex items-center gap-2">
                <Plus size={24} className="text-[#11BA3C]" />
                Select a Template
              </DialogTitle>
              <DialogDescription>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {filteredTemplates.length > 0 ? (
                    filteredTemplates.map((template) => (
                      <div
                        key={template.id}
                        className={`relative border rounded-lg p-4 cursor-pointer transition-all duration-300 ease-in-out scale-100 hover:scale-105 ${
                            selectedTemplate === template.id
                              ? "border-[#11BA3C]  shadow-[0_0_0_1px_#11BA3C,0_8px_20px_rgba(17,186,60,0.15)]"
                              : "hover:border-[#11BA3C] shadow-[0_2px_8px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_20px_rgba(0,0,0,0.1)]"
                          }`}
                      ...
                      >
                        ...
                        {selectedTemplate === template.id && (
                          <div className="absolute top-2 left-2 bg-[#11BA3C] text-white rounded-full p-1">
                            <Check size={14} />
                          </div>
                        )}
            ...
            <div className="flex justify-between gap-3 mt-4 pt-4 border-t">
              ...
              <div className="flex gap-3">
                ...
                <Button
                  className="bg-[#11BA3C] hover:bg-[#0e8a2c] text-white"
          ...
          <>
            <DialogHeader>
              <DialogTitle className="text-2xl font-bold text-[#11BA3C]">
            ...
            <div className="flex flex-col gap-6 py-4">
              ...
              <div className="p-4 shadow-[0_0_0_1px_#11BA3C,0_8px_20px_rgba(17,186,60,0.15)] rounded-lg border">
                  ...
                  {templates
                    ...
                    ?.features.map((feature) => (
                      <div key={feature} className="flex items-center gap-2">
                        <Zap size={14} className="text-[#11BA3C]" />
